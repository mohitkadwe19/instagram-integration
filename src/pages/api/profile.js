...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.INSTAGRAM_API_URL}/${userId}?fields=id,username,biography,website,followers_count,follows_count,profile_picture_url,account_type,media_count&access_token=${accessToken}`
    );

...
import { FaInstagram, FaSignInAlt, FaSpinner, FaRegComment, FaUserCircle, FaImages } from "react-icons/fa";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-white overflow-hidden">
        <Head>
          ...
          <meta name="description" content="Connect your Instagram account to view your profile and media" />
          ...
          <header className="py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <span className="ml-3 text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600">Instagram Integration</span>
              </div>
              <motion.div 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="mt-6 text-xl text-gray-600 max-w-3xl leading-relaxed">
                  View your profile, posts, and engage with comments all in one beautiful interface.
                </p>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Rich Profile Display</h3>
                    <p className="text-gray-600 leading-relaxed">
                      View your Instagram profile details in a beautifully designed, organized interface with all your important stats.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Interactive Media Feed</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Browse your Instagram photos, videos, and carousel posts in a dynamic, responsive gallery with smooth transitions.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Smart Comment Management</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Reply to comments on your posts with an intuitive interface that makes engaging with your audience effortless.
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            >
              ...
              <div className="relative px-6 py-12 md:py-16 md:px-12 text-center">
                ...
                <p className="max-w-xl mx-auto text-lg text-purple-100 mb-10">
                  Join thousands of users who are already managing their Instagram presence more effectively with our platform.
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
          ...
          <footer className="py-12 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <span className="ml-2 font-semibold text-gray-900">Instagram Integration</span>
              </div>
    ...
    return (
      <Layout title="Loading...">
        <div className="min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <p className="mt-6 text-lg text-gray-600">Loading your Instagram data...</p>
        </div>
      </Layout>
    );
  }
